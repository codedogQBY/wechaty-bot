...
import { getTextMaterialList } from '@/api/system/material';
import MaterialDialog  from '../MaterialDialog'
import {deleteMaterialById} from "@/api/system/material";
  ...
  setup() {
      ...
      const buttons = reactive<ToolButton<number, MaterialFormData>[]>([
          ...
          },
          {
              ...
              action: 'delete',
              vAction: 'system:material:delete',
              icon: 'delete',
              text: '删除',
          },
          {
    ...
    return (
        <div class="container">
            <TableLayout
                ...
                buttons={buttons}
                columns={columns}
                search={getTextMaterialList}
            ></TableLayout>
            <MaterialDialog ref="materialDialogRef" onUpdate={reSearch}></MaterialDialog>
        </div>
    );
  },
});
